						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Recipes
									<!--begin::Separator-->
                                                ...
                                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                                        ...
                                                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                                                            <!--begin::Input group-->
                                                            <form id="form-filter" method="GET" action="<?= site_url('recipes') ?>" class="mb-3">
                                                                <div class="input-group w-auto mb-3">
                                                                    <div class="fs-5 text-dark fw-bolder pb-2">Title</div>
                                                                    <input type="text" name="title" class="form-control form-control-solid w-250px" value="<?= htmlspecialchars($Title) ?>" placeholder="Search"/>
                                                                </div>
                                                                <div class="input-group w-auto mb-3">
                                                                    <div class="fs-5 text-dark fw-bolder pb-2">Description</div>
                                                                    <input type="text" name="description" class="form-control form-control-solid w-250px" value="<?= htmlspecialchars($Description) ?>" placeholder="Search"/>
                                                                </div>
                                                                <!--begin::Actions-->
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                                ...
                                                <thead>
													...
													<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">
															<a href="<?= site_url(relativePath: 'recipes?title=' . urlencode($Title) . '&description=' . urlencode($Description) . '&sortField=Username&sortOrder=' . (($sortField == 'Username' && $sortOrder == 'asc') ? 'desc' : 'asc')) ?>">
																Username
