...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../">
		<title><?= isset($favorite) ? 'Edit Favorite' : 'Add Favorite' ?></title>
                        ...
                        <div class="toolbar" id="kt_toolbar">
                            ...
                            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                                ...
                                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                    <!--begin::Title-->
                                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><?= isset($favorite) ? 'Edit Favorite' : 'Add Favorite' ?>
                                    <!--begin::Separator-->
                                ...
                                <div class="d-flex flex-column flex-xl-row">
                                    ...
                                    <div class="flex-column flex-lg-row-auto w-100 w-xl-350px mb-10">
                                        ...
                                        <div class="card mb-7 mb-xl-8 add-user">
                                            ...
                                            <!--begin::Card body-->
                                            <div class="card-body">
                                                <form action="<?= isset($favorite['ID']) ? site_url('favorites/save/') . $favorite['ID'] : site_url('favorites/save') ?>" method="post" class="form">
                                                    <!--begin::Scroll-->
                                                    ...
                                                    <div class="text-center pt-15">
                                                        <button type="reset" class="btn btn-light me-3" data-kt-recipes-modal-action="cancel">Discard</button>
                                                        <button type="submit" class="btn btn-primary" data-kt-recipes-modal-action="submit">
